  ...
  return (
    <Layout>
      <section className={ styles.content }>
        ...
        <p>
          I&apos;m <a href='https://github.com/mattmacleod' target='_blank' rel='noreferrer'>@mattmacleod</a>, and this is a small web application for storing and publishing recipes I use. It contains a variety of different recipes that I&apos;ve been making over the years, and they come from lots of different sources.
        ...
        <p>
          This site is inspired by <a target='_blank' rel='noreferrer' href='https://chowdown.io'>chowdown.io</a>, which is a similar project using a different implementation and backend.
        </p>
        <p>
          The content on this site is licensed under a <a rel='noreferrer license' href='https://creativecommons.org/licenses/by/4.0/' target='_blank'>Creative Commons Attribution 4.0 International License</a>. This means that you can use it for any purpose, so long as you give attribution. Please link back to this site if you do use these recipes elsewhere. The code itself is under an <a rel='noreferrer license' href='https://raw.githubusercontent.com/mattmacleod/recipe-book/main/LICENSE.txt' target='_blank'>MIT License</a>.
        </p>
        <p>
